...
class AddIdStatuskeuTorCreatebyToTrxStatusKeu extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('trx_status_keu', function (Blueprint $table) {
            $table->unsignedBigInteger('id_status')->after('id');
            $table->foreign('id_status')->references('id')->on('status_keu')->onDelete('cascade')->onUpdate('cascade');
