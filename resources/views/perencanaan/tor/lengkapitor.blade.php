                            ...
                            <div class="container center" id="iniprint">
                                <?php
                                    ...
                                    for ($trx = 0; $trx < count($trx_status_tor); $trx++) {
                                        if ($trx_status_tor[$trx]->id_tor == $tor->id) { 
                                    ...
                                    for ($trx1 = 0; $trx1 < count($trx_status_tor); $trx1++) {
                                        if ($trx_status_tor[$trx1]->id_tor == $tor->id) {
                                            ...
                                            <table id="datatable" class="table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td colspan="4">{{$tor->nama_kegiatan}}
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            <th scope="col" rowspan="2" class="align-middle">Komponen Input
                                                                                <?php if ($disetujui != 1 && $tor->nama_pic == Auth::user()->name || $RoleLogin == "Prodi" || $RoleLogin == "Admin") { ?>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td colspan="7">
                                                            {{"Rp. ".number_format($tor->jumlah_anggaran,2,',',',')}}
                                                        </td>
                                                    </tr> --}}
                                                    <tr>
                                                        <td colspan="8"></td>
