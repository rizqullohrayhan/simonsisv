...
<script src="{{ asset('findash/assets/js/raphael-min.js') }}"></script>
<!-- Morris JavaScript -->
<script src="{{ asset('findash/assets/js/morris.js') }}"></script>
<!-- Morris min JavaScript -->
<script src="{{ asset('findash/assets/js/morris.min.js') }}"></script>
<!-- Flatpicker Js -->
<script src="{{ asset('findash/assets/js/flatpickr.js') }}"></script>
<!-- Style Customizer -->
